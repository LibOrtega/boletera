const newRegisterTemplate = (data) => {
  ...
  const { name, ticketType, qrUrl, startTimeLocalText, place, eventName } =
    data;
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr style="line-height:0px"><td style="padding-right: 0px;padding-left: 0px;" align="center"><![endif]--><img align="center" border="0" class="center autowidth" src="https://res.cloudinary.com/patitorosa/image/upload/v1657163884/extras/patitorosa_rrddud.png" style="text-decoration: none; -ms-interpolation-mode: bicubic; height: auto; border: 0; width: 500px; max-width: 100%; display: block;" width="500"/>
...
<br />
	...
	${
    ticketType && ticketType === "participants"
      ? `<p
            style="color: #000000; margin: 0; font-size: 14px; line-height: 1.2; word-break: break-word; mso-line-height-alt: 17px; margin-top: 0; margin-bottom: 0;">
           En tu caso eres participante del evento!! <br/> Por favor llega unos minutos antes de que comience el evento</p>`
      : ``
  }
